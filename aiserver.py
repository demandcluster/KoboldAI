...
def general_startup(override_args=None):
    ...
    parser.add_argument("--sh_apikey", help="Specify the API key to use for txt2img from the Stable Horde. Get a key from https://horde.aivo.chat/register")
    ...
    if not id_req.ok:
        if id_req.status_code == 403:
            show_error_notification(
                ...
                "Try again in a few minutes or register for priority access at https://horde.aivo.chat",
                do_log=True
            )
            return None
