...
class WebUI:
    ...
    INFO = {
        ...
        "api_key": {
            "label": "API Key",
            "info": "This is your Stable Horde API Key. You can get one free at " "https://horde.aivo.chat/register ",
        },
        "horde_url": {
    ...
    def load_workerID(self, worker_name):
        workerID = ""
        workers_URL = "https://horde.aivo.chat/api/v2/workers"
    ...
    def update_worker_mode(self, worker_name, worker_id, current_mode, apikey):
        ...
        worker_URL = f"https://horde.aivo.chat/api/v2/workers/{worker_id}"
